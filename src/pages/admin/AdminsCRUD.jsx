...
function AdminsCRUD() {
  ...
  const loggedInIsSuper = admin.isSuper;
  console.log(loggedInIsSuper);
  ...
  const fetchAdmins = async () => {
    try {
      const response = await axios.get(
        "https://backend-mu-ten-26.vercel.app/admin"
      );
  ...
  const handleDeleteAdmin = async (admin) => {
    ...
    try {
      await axios.delete(
        `https://backend-mu-ten-26.vercel.app/admin/${admin._id}`
      );
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            ...
            <button className="flex items-center justify-center gap-2 rounded-lg h-10 px-5 bg-[var(--oasis-green)] text-white text-sm font-medium shadow-sm hover:bg-green-700 transition-colors">
              ...
              <NavLink to="/admin/addNewAdmin" className="truncate">
                Add New Admin
              </NavLink>
            </button>
          </div>
                            ...
                            <td className="table-body-cell text-right ">
                              ...
                              >
                                <svg
                                  ...
                                  strokeWidth={1.5}
                                  stroke="currentColor"
                                  className="size-6 inline text-blue-500 hover:text-blue-700 cursor-pointer"
                                >
                                  <path
                                    strokeLinecap="round"
