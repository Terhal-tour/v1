...
function PlaceInfo() {
    ...
    const handleRate = async (value) => {
        try {
            await axios.post(`http://localhost:3000/places/${place._id}/rate`, {
                rating: value,
            }, {
                headers: {
    ...
    const handleFavourite = async () => {
        try {
            await axios.post(`http://localhost:3000/places/${place._id}/favourite`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
                }
    ...
    useEffect(() => {
        axios.get(`http://localhost:3000/places/${_id}`, {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
            },
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {suggestions && suggestions.map(suggestedPlace => (
                                <NavLink to={`/places/${suggestedPlace._id}`}
                                    ...
                                    <div className="p-4">
                                        <h4 className="text-lg font-bold">{suggestedPlace.name}</h4>
