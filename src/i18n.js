...
const resources = {
  EN: {
    translation: {
      ...
      please_wait: 'Our AI is crafting your perfect day',
      generate_recomendation: "Generating recommendations...",
      Save: "Save",
      updated_now: "Updated just now",
      powered_by: "Powered by intelligence",
      ai_travel_guide:"AI Travel Guide",
      try_refresh:"Try refreshing or check your location settings",
      no_near_places:"No nearby places found",
      for_u:"Handpicked for you",
      nearby_gems:"Nearby Gems",
      current_weather:"Current Weather",
      coordinates:"GPS Coordinates",
      c_Location:"Current Location",
      smart_travel_recommendations: "Smart Travel Recommendations",
      discover_personalized_places: "Discover personalized places just for you",
  ...
  AR: {
    translation: {
      ...
      explore_on_map: 'استكشاف على الخريطة',
      please_wait: 'يرجى الانتظار...',
      generate_recomendation: "جار انشاء اقتراح مناسب لك ...",
      save: "حفظ",
      updated_now: "تم التحديث الان ",
      powered_by: "مدعوم بالذكاء الاصطناعي",
  ai_travel_guide: "دليل السفر الذكي",
  try_refresh: "حاول التحديث أو تحقق من إعدادات الموقع",
  no_near_places: "لم يتم العثور على أماكن قريبة",
  for_u: "مختارة خصيصًا لك",
  nearby_gems: "أماكن قريبة مميزة",
