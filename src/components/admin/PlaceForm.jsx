...
export default function PlaceForm({ initialData, onSubmitSuccess }) {
    // sessionStorage.setItem('jwt', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4NzRlZTllNzMzMzE4MTAzYmJkNmUwYyIsImlhdCI6MTc1MjY0NjkyOSwiZXhwIjoxNzUzMjUxNzI5fQ.2HApWt39w0OOMiGjIzieF6h7xe3EBsF_Iu7tSTVOwm4');
