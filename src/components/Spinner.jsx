...
const Spinner = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh]">
    <span className="relative flex h-20 w-20 items-center justify-center">
      ...
      {/* Main spinner ring */}
      <svg
        className="animate-spin h-20 w-20 text-[var(--color-gold)] drop-shadow-xl"
        viewBox="0 0 50 50"
      >
        <circle
    ...
    <div
      className="mt-6 text-lg font-extrabold text-[var(--color-nile-blue)] tracking-wide animate-pulse"
